...
if (isset($_POST['submit'])) {
  $data = mysqli_fetch_assoc(select__laporan01diklat());
  if (empty($data)) {
      insert__laporan01diklat();
      }else if ($data = 1) {
        edit__laporan01diklat();
      }
}

$id = mysqli_fetch_assoc(select__laporan01diklat());

$menu = 'Laporan 01 Diklat';
        ...
        <div class="row">
          <div class="card-body">
            <div class="row">
              <div style="text-align: right;" class="container-fluid">
                  ...
                  <div class="col-md-3 col-xs-5">
                    <div class="row">
                      ...
                      <div class="col-md-2 col-xs-3">
                        <div data-toggle="modal" data-target="#tambah-laporan01diklat">
                          <button type="button" class="btn btn-primary laporan01diklat" data-toggle="tooltip" title="Tambah">
                ...
                <?php
                $file_lama = mysqli_fetch_assoc(select__laporan01diklat());
                ?>

                <!-- Modal -->
                <div class="modal fade" id="tambah-laporan01diklat" tabindex="-1" role="dialog" aria-labelledby="tambah-laporan01diklat" aria-hidden="true">
                    ...
                    <div class="modal-content">
                      <form action="" form name="myForm" onsubmit="return validateForm()" method="POST" enctype="multipart/form-data">
                        <div class="modal-header">
                          ...
                          <b><p class="modal-title" id="tambah-laporan01diklat" style="text-align: center; font-size: 18px;">Tambah <?= $menu ?></p></b>
                        </div>
          ...
          <div class="container-fluid">
            <table class="table table-bordered" style="color: black;">
              ...
              <tbody>
<?php $i = 1; foreach (select__laporan01diklat() as $key): ?>                
                <tr>
                  <td scope="col"><?= $i++; ?></td>
                  <td scope="col">
                    <?php
                  ...
                  <td scope="col">
                    ...
                    <div data-toggle="modal" data-target="#info-laporan01diklat">
                      <button type="button" class="btn btn-default laporan01diklat" data-toggle="tooltip" title="View">
                        <i class="fa fa-eye"></i>
                      </button>
                    </div>

                    <!-- Modal -->
                    <div class="modal fade" id="info-laporan01diklat" tabindex="-1" role="dialog" aria-labelledby="info-laporan01diklat" aria-hidden="true">
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            ...
                            <b><p class="modal-title" id="info-laporan01diklat" style="text-align: center; font-size: 18px;">Isi <?= $menu ?></p></b>
                          </div>
                          <div class="modal-body">
                            <center>Silahkan Unduh FIle</center>
                          </div>
                          <div class="modal-footer">
                            <a href="assets/file/laporan01diklat/<?= $key['file'] ?>">
                    ...
                    <div data-toggle="modal" data-target="#unduh-file">
                      <button type="button" class="btn btn-success laporan01diklat" data-toggle="tooltip" title="Unduh">
...
<script>
  $('.laporan01diklat').tooltip({ boundary: 'window' })
</script>  
