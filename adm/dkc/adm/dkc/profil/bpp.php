    ...
    <div class="container-fluid">
      ...
      <div style="text-align: right;">
         <div data-toggle="modal" data-target="#tambah-agenda">
          <?php $jumlahbpp = mysqli_num_rows(select__profilbpp()) ?>
          <button type="button" class="btn btn-primary agenda" data-toggle="tooltip" title="Upload" <?php if ($jumlahbpp == 3) {
            echo "disabled";
          } ?>>
               ...
               <form action="" method="POST" enctype="multipart/form-data">
                <div class="modal-body">
                  ...
                  <div class="modal-footer">
                    <button type="submit" name="submit_bpp" id="endButton" class="btn btn-primary">Simpan</button>
