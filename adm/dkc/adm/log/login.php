            ...
            <form action="ceklog.php" method="POST">
                ...
                <div class="head2">
                    ...
                    <div>
                      ...
                      <input type="password" name="password" placeholder="password" class="form_login" id="myInput">
                      <i onclick="myFunction()" class="fa fa-fw fa-eye field-icon toggle-password"></i>
                    </div><br>
                </div>
                <div class="head3">
                    <br><br><br><br>
