...
<div class="swiper-container">
  <div class="swiper-wrapper">  
    <?php foreach (prestasi__menu() as $key): ?>    
  ...
  <div class="row">
    ...
    <div class="col-md-12 col-xs-12 col-sm-12">
      <div class="card" style="padding: 20px; box-shadow: 1px 2px 8px rgba(0, 0, 0, 0.45);">
        <div class="row">
          <div class="card-body">
            <h1><p class="card-title" style="font-size: 18px; text-align: center; font-family: 'Montserrat', sans-serif;">PRESTASI</p></h1>
            <br>
          </div>
<?php foreach (select__prestasi() as $key): ?>                      
          <div class="col-md-6 col-xs-12 col-sm-12">
            <ul class="list-group list-group-flush">
            <li class="list-group-item">
              <div class="row">
                <div class="col-md-3 col-xs-4" style="padding-top: 10px;">
                  <img src="<?= url(); ?>adm/dkc/adm/assets/file/prestasi/<?= $key['gambar'] ?>" class="img-responsive img-circle" style="box-shadow: 1px 2px 8px rgba(0, 0, 0, 0.45);">
                </div>
                <div class="col-md-9 col-xs-8" style="padding-top: 10px;">
                  <p><b><?= $key['judul'] ?></b></p>
                  <p><?= $key['isi'] ?></p>
                </div>
              </div>
