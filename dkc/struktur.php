...
$struktur = mysqli_fetch_assoc(select__struktur());
...
<body>
  ...
  <div class="swiper-container">
    <div class="swiper-wrapper">  
      <?php foreach (struktur__menu() as $key): ?>    
  ...
  <div class="row">
    ...
    <div class="col-md-12 col-xs-12 col-sm-12">
      <div class="card" style="padding: 20px; box-shadow: 1px 2px 8px rgba(0, 0, 0, 0.45);">
        <div class="row">
          <div class="card-body">
            <h1><p class="card-title" style="font-size: 18px; text-align: center; font-family: 'Fredoka One';">STRUKTUR ORGANISASI</p></h1>
            <br>
          ...
          <div class="col-md-12 col-xs-12 col-sm-12">
            <div class="card mb-3">
              <div class="card-body">
                <div class="card-text">
                  <center>
                    <a href="<?= url(); ?>adm/dkc/adm/assets/file/struktur/<?= $struktur['gambar'] ?>">
                     <img src="<?= url(); ?>adm/dkc/adm/assets/file/struktur/<?= $struktur['gambar'] ?>" class="img-responsive" style="width: 500px">
                    </a>
                  </center>
                </div>
              </div>
