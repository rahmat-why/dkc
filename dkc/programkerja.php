...
<body>
  ...
  <div class="swiper-container">
    <div class="swiper-wrapper">  
      <?php foreach (programkerja__menu() as $key): ?>    
  ...
  <div class="row">
    ...
    <div class="col-md-12 col-xs-12 col-sm-12">
      <div class="card" style="padding: 20px; box-shadow: 1px 2px 8px rgba(0, 0, 0, 0.45);">
        <div class="row">
          <div class="card-body">
            <h1><p class="card-title" style="font-size: 18px; text-align: center; font-family: 'Fredoka One';">PROGRAM KERJA</p></h1>
            <br>
            
          </div>
<?php foreach (select__programkerja() as $key): ?>           
            ...
            <ul class="list-group list-group-flush">
              <li class="list-group-item">
                <div class="row">
                  ...
                  <div class="col-md-3 col-xs-3" style="border: 1px solid black; text-align: center; padding: 10px; border-color:#f0f0f5;">
                    <p style="padding-top: 10px;"><b><?= $key['tahun'] ?></b></p>
                  </div>
                </div>
              </li>
            </ul>
