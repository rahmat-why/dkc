...
<?php $data = mysqli_fetch_assoc(select__aturangerakanpramuka()); ?>
  ...
  <div class="row">
    ...
    <div class="col-md-12 col-xs-12 col-sm-12">
      <div class="card" style="padding: 20px; box-shadow: 1px 2px 8px rgba(0, 0, 0, 0.45);">
        <div class="row">
          <div class="card-body">
            <h1><p class="card-title" style="font-size: 18px; text-align: center; font-family: 'Montserrat', sans-serif;">Pedoman Gerakan Pramuka</p></h1>
            <br>
...
?>    
                <tr>
                    <td><?= $key['kategori'] ?></td>
                    <td>
                        <a href="../adm/dkc/adm/assets/file/aturan/<?= $key['file'] ?>">Unduh disini</a>
                    </td>
                </tr>
<?php endforeach; ?>    	
            </table>
